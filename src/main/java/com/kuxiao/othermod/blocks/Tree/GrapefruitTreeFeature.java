 ...
 * 树本类
 */
public class GrapefruitTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {

    private static final BlockState LOG = ModBlocks.grapefruitTree.getLogs().getDefaultState();
    private static final BlockState LEAF = ModBlocks.grapefruitTree.getLeaves().getDefaultState();
    private final boolean useExtraRandomHeight;

    public GrapefruitTreeFeature(String name,Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, boolean extraRandomHeightIn) {
        super(configIn, doBlockNotifyIn);
        this.useExtraRandomHeight = extraRandomHeightIn;
        this.setSapling((net.minecraftforge.common.IPlantable) ModBlocks.grapefruitTree.getSapling());
        this.setRegistryName(Othermod.MODID,name);
        ModTree.MODTREES.add(this);
    }
